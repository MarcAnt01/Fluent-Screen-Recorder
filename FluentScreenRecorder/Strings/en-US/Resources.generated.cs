...
namespace FluentScreenRecorder.Strings{
    ...
    public static class Resources {
        ...
        public static string BugReport
        {
            get
            {
                return _resourceLoader.GetString("BugReport");
            }
        }
        #endregion
        ...
        public static string Copyright
        {
            get
            {
                return _resourceLoader.GetString("Copyright");
            }
        }
        #endregion
        ...
        public static string Discord
        {
            get
            {
                return _resourceLoader.GetString("Discord");
            }
        }
        #endregion
        ...
        public static string Failure
        {
            get
            {
                return _resourceLoader.GetString("Failure");
            }
        }
        #endregion
        ...
        public static string Framerate
        {
            get
            {
                return _resourceLoader.GetString("Framerate");
            }
        }
        #endregion
        ...
        /// </summary>
        public static string GalleryView
        {
            get
            {
        ...
        #region GitHub
        /// <summary>
        ///   Looks up a localized string similar to: View GitHub repository
        /// </summary>
        ...
        public static string Privacy
        {
            get
            {
                return _resourceLoader.GetString("Privacy");
            }
        }
        #endregion
        ...
        public static string Resolution
        {
            get
            {
                return _resourceLoader.GetString("Resolution");
            }
        }
        #endregion
        ...
        public static string Share
        {
            get
            {
                return _resourceLoader.GetString("Share");
            }
        }
        #endregion
        ...
        public static string VideoPreview
        {
            get
            {
                return _resourceLoader.GetString("VideoPreview");
            }
        }
        #endregion
        ...
        public static string Whatsnew
        {
            get
            {
                return _resourceLoader.GetString("Whatsnew");
            }
        }
        #endregion
